...
exports.register = async (request, response, next) => {
    const { firstName, lastName, location, title, techStacks, isMentor } = request.body;
    ...
    try {
        await User.create({ firstName, lastName, location, title, techStacks, isMentor, image: imageUrl })
            .then((user) => {
